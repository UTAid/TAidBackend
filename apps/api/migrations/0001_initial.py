# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-07-21 19:15
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('schedule', '0005_auto_20170718_1303'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(max_length=20)),
                ('event', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.TaidEvent')),
